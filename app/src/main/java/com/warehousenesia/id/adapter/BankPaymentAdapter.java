...
public class BankPaymentAdapter extends RecyclerView.Adapter<BankPaymentAdapter.ViewHolder> {

    private LayoutInflater inflater;
    private ArrayList<DataBank> BankList;

    public BankPaymentAdapter(Context context, ArrayList<DataBank> BankList){
    ...
    @NonNull
    @Override
    public BankPaymentAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.item_bank_payment, parent, false);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull BankPaymentAdapter.ViewHolder holder, int position) {
